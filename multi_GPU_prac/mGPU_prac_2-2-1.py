...
with mirrored_strategy.scope():
    ...
    x0 = tf.slice(  x, begin=[0, temp_size,0], 
                    size=[-1, tensor_slice_size, tmp_shape[-1]])
    ...
    tf.keras.utils.plot_model(model, "proto_model_with_shape_info_cnn_1.png", show_shapes=True)
...
open('D:\\test_tflite_file_cnn_1_slice.tflite', 'wb').write(tflite_model)
