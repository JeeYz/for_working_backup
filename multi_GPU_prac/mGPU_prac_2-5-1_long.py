...
resizing_row_size = 16
resizing_column_size = 64 
...
with mirrored_strategy.scope():
    ...
    x0 = preprocessing.Resizing(resizing_row_size, resizing_column_size)(x0) 
    x0 = layers.BatchNormalization()(x0)

    x1 = preprocessing.Resizing(resizing_row_size, resizing_column_size)(x1) 
    x1 = layers.BatchNormalization()(x1)

    x2 = preprocessing.Resizing(resizing_row_size, resizing_column_size)(x2) 
    x2 = layers.BatchNormalization()(x2)

    x3 = preprocessing.Resizing(resizing_row_size, resizing_column_size)(x3) 
    x3 = layers.BatchNormalization()(x3)

    x4 = preprocessing.Resizing(resizing_row_size, resizing_column_size)(x4) 
    x4 = layers.BatchNormalization()(x4)

    x5 = preprocessing.Resizing(resizing_row_size, resizing_column_size)(x5) 
    x5 = layers.BatchNormalization()(x5)

    x6 = preprocessing.Resizing(resizing_row_size, resizing_column_size)(x6) 
    x6 = layers.BatchNormalization()(x6)

    x7 = preprocessing.Resizing(resizing_row_size, resizing_column_size)(x7) 
    x7 = layers.BatchNormalization()(x7) 

    x8 = preprocessing.Resizing(resizing_row_size, resizing_column_size)(x8) 
    x8 = layers.BatchNormalization()(x8)

    x9 = preprocessing.Resizing(resizing_row_size, resizing_column_size)(x9) 
    ...
    cnn_block_9 = CNN_block(channel_size=cnn_chan_size)
    ...
    tf.keras.utils.plot_model(model, "proto_model_with_shape_info_cnn_lstm_1_long.png", show_shapes=True)
...
open('D:\\test_tflite_file_lstm_1_slice_long.tflite', 'wb').write(tflite_model)
