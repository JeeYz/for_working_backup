...
with mirrored_strategy.scope():
    ...
    x4 = layers.Dense(512, activation='relu')(x4)
    x5 = layers.Dense(512, activation='relu')(x5)
    x6 = layers.Dense(512, activation='relu')(x6)
    x7 = layers.Dense(512, activation='relu')(x7)
    ...
    x6 = layers.Dense(256, activation='relu')(x6)
    x7 = layers.Dense(256, activation='relu')(x7)
