...
with mirrored_strategy.scope():
    ...
    tf.keras.utils.plot_model(model, "proto_model_with_shape_info_resnet_lstm_2.png", show_shapes=True)
...
open('D:\\test_tflite_file_lstm_2_slice.tflite', 'wb').write(tflite_model)
